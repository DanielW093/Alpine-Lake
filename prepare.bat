...
if exist submit_me.zip del submit_me.zip
...
echo zipname = "submit_me">> __tmpJustZipCI4500.vbs
...
if exist submit_me.zip goto success
...
:success
echo.
echo Your files have been successfully packed into the following file: submit_me.zip
